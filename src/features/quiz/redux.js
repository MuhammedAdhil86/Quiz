...
const questionsData = shuffleArray([
    {
      ...
      },
      {
        ...
        options: ['Electrocardiogram', 'Electroencephalogram', 'Echocardiography', 'Electromyography'],
      ...
      },
      {
        ...
        options: ['Streptococcus pneumoniae', 'Mycobacterium tuberculosis', 'Escherichia coli', 'Staphylococcus aureus'],
        correctAnswer: 'Mycobacterium tuberculosis',
      },
      {
        question: 'What is the main function of hemoglobin?',
        options: ['Fight infection', 'Blood clotting', 'Oxygen transport', 'Digest food'],
      ...
      },
      {
        ...
        options: ['Increase blood pressure', 'Transport oxygen', 'Regulate blood sugar', 'Promote digestion'],
        correctAnswer: 'Regulate blood sugar',
      },
      {
        question: 'Which type of immunity is provided by vaccination?',
        options: ['Passive natural immunity', 'Active artificial immunity', 'Passive artificial immunity', 'Active natural immunity'],
        correctAnswer: 'Active artificial immunity',
      },
      {
        question: 'What does the term “tachypnea” refer to?',
        options: ['Slow heart rate', 'Rapid breathing', 'Low blood pressure', 'Excessive urination'],
      ...
      },
      {
        ...
        options: ['Escherichia coli', 'Lactobacillus', 'Staphylococcus', 'Clostridium'],
      ...
      },
      {
        ...
        options: ['8–12 breaths/min', '12–20 breaths/min', '20–30 breaths/min', '25–35 breaths/min'],
      ...
      {
        question: 'Which is the preferred injection site for intramuscular injection in adults?',
      ...
      },
      {
        ...
        options: ['Escherichia coli', 'Staphylococcus aureus', 'Salmonella typhi', 'Neisseria gonorrhoeae'],
        correctAnswer: 'Staphylococcus aureus',
      },
      {
        question: 'Which electrolyte imbalance is most associated with cardiac arrhythmia?',
      ...
      {
        question: 'Which theory emphasizes the importance of unconscious mind in behavior?',
        options: ['Behavioral theory', 'Cognitive theory', 'Psychoanalytic theory', 'Humanistic theory'],
      ...
      },
      {
        ...
        options: ['Salmonella typhi', 'Shigella dysenteriae', 'Vibrio cholerae', 'Escherichia coli'],
      ...
      },
      {
        ...
        options: ['Loop of Henle', 'Bowman’s capsule', 'Distal tubule', 'Collecting duct'],
      ...
      {
        question: 'Which enzyme is responsible for the breakdown of starch in the mouth?',
      ...
      {
        question: 'Which method of sterilization is best for metal surgical instruments?',
      ...
      },
      {
        ...
        options: ['Blood in stool', 'Blood in urine', 'Vomiting blood', 'Coughing blood'],
      ...
      {
        question: 'Which type of immunity is passed from mother to baby through breast milk?',
  ...
  reducers: {
    answerQuestion: (state, action) => {
      ...
      if (isLevelEnd || state.currentIndex === state.questions.length - 1) {
        const start = state.currentIndex + 1 - (isLevelEnd ? questionsPerLevel : (state.currentIndex + 1) % questionsPerLevel);
        const currentLevelAnswers = state.userAnswers.slice(start, state.currentIndex + 1);
        const correctCount = currentLevelAnswers.filter(q => q.isCorrect).length;
...
export const { answerQuestion, resetQuiz, toggleReview, goToNextLevel } = quizSlice.actions;
