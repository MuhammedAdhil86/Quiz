...
function ResultPage() {
  ...
  const { score, questions, showReview, userAnswers, levelResults } =
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-green-50 to-blue-100 px-4 py-12 text-center relative overflow-hidden">
      ...
      >
        ...
        of <span className="text-blue-600 font-bold">{questions.length}</span>
      </motion.p>
        ...
        >
          ...
          <div className="mt-6">
            {levelResults.map((level) => (
              <div
                key={level.level}
                className="p-4 bg-white shadow rounded-lg mt-4"
              >
